...
export default async function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row max-w-[1100px] mx-auto items-center justify-between gap-3 px-5 py-8 text-sm">
      ...
      <nav className="w-full md:w-auto">
        <ul className="flex flex-col justify-center items-center md:flex-row gap-3 lg:gap-5">
          <li>
            <Link
